...
import (
	...
	"github.com/ivangonzalezacuna/redis-operator/internal/controller"
...
func init() {
	...
	utilruntime.Must(ivangonzalezacunav1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "d8ddf4cf.docker.io",
